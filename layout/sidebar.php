...
if ($user_role == 'admin')           { $base = '../admin1/'; }
elseif ($user_role == 'receptionist'){ $base = '../receptionist/'; }
elseif ($user_role == 'trainer')     { $base = '../trainer/'; }
elseif ($user_role == 'accountant')  { $base = '../accountant/'; }
elseif ($user_role == 'customer')    { $base = '../customer/'; }
else                                 { $base = '../'; }

$menus = [
    'admin' => [
        'dashboard'     => true, 'members'   => true, 'staff'      => true,
        'attendance'    => true, 'announcements' => true, 'payments' => true,
        'equipment'     => true, 'reports'   => true, 'settings'   => true
    ],
    'trainer' => [
        'dashboard'        => true, 'assigned_members' => true,
        'attendance'       => true, 'announcements'    => true, 'reports' => false
    ],
    'receptionist' => [
        'dashboard'            => true, 'members'     => true,
        'attendance'           => true, 'announcements' => true,
    ...
    'customer' => [
        'dashboard'     => true, 'my_profile'    => true, 'my_attendance' => true,
        'my_workout'    => true, 'my_payments'   => true, 'my_progress'   => true,
        'announcements' => true
    ]
];
...
<aside class="sidebar">
  ...
  <div class="nav-section">
    ...
    <ul class="nav-list">
      ...
      <?php $dashboard_file = ($user_role === 'admin') ? 'dashboard1.php' : 'index.php'; ?>
      ...
      <li class="submenu">
        ...
        <ul class="submenu-items">
          <li class="<?php if($page=='members') echo 'active'; ?>">
            <a href="../modules/members.php"><i class="fas fa-arrow-right"></i> List All Members</a>
          </li>
          <?php if ($user_role == 'admin' || $user_role == 'receptionist'): ?>
          <li class="<?php if($page=='members-entry') echo 'active'; ?>">
            <a href="../modules/member-entry.php"><i class="fas fa-arrow-right"></i> Member Entry Form</a>
          </li>
          <?php endif; ?>
        </ul>
      </li>
      ...
      <li class="submenu">
        ...
        <ul class="submenu-items">
          <li class="<?php if($page=='staff-list') echo 'active'; ?>">
            <a href="<?= $base ?>staff-list.php"><i class="fas fa-arrow-right"></i> View All Staff</a>
          </li>
          <li class="<?php if($page=='staff-add') echo 'active'; ?>">
            <a href="<?= $base ?>staff-add.php"><i class="fas fa-arrow-right"></i> Add Staff</a>
          </li>
        </ul>
      </li>
      <?php endif; ?>
      ...
      <li class="<?php if($page=='assigned-members') echo 'active'; ?>">
        <a href="<?= $base ?>assigned-member.php"><i class="fas fa-users-cog"></i><span>Assigned Members</span></a>
      </li>
      <li class="<?php if($page=='workout-plans') echo 'active'; ?>">
        <a href="<?= $base ?>workout-plans.php"><i class="fas fa-dumbbell"></i><span>Workout Plans</span></a>
      </li>
      <li class="<?php if($page=='schedule') echo 'active'; ?>">
        <a href="<?= $base ?>schedule.php"><i class="fas fa-calendar-alt"></i><span>Schedule</span></a>
      </li>
      <?php endif; ?>
      ...
      <li class="submenu">
        ...
        <ul class="submenu-items">
          ...
          <li class="<?php if($page=='attendance-report') echo 'active'; ?>">
            <a href="../modules/attendance-report.php"><i class="fas fa-arrow-right"></i> Attendance Reports</a>
          </li>
          <?php endif; ?>
        </ul>
      </li>
      ...
      <li class="<?php if($page=='members-list') echo 'active'; ?>">
        <a href="../modules/members.php"><i class="fas fa-list"></i><span>Members List</span></a>
      </li>
      <?php endif; ?>

      <?php if (!empty($user_menu['announcements'])): ?>
      <li class="<?php if($page=='announcements') echo 'active'; ?>">
        <a href="../modules/announcements.php"><i class="fas fa-bullhorn"></i><span>Announcements</span></a>
      </li>
      <?php endif; ?>
      ...
      <li class="submenu">
        <input type="checkbox" id="payments-menu" class="toggle-input"
          <?php if(in_array($page,['payments','make-payment','salary-payments','search-payment','payment-list','record-payment','member-collections','payment-report'])) echo 'checked'; ?>>
        ...
        <ul class="submenu-items">
          ...
          <li class="<?php if($page=='payments') echo 'active'; ?>">
            <a href="../modules/payments.php"><i class="fas fa-arrow-right"></i> All Payments</a>
          </li>
          <?php endif; ?>
          <?php if ($user_role == 'accountant'): ?>
          <li class="<?php if($page=='make-payment') echo 'active'; ?>">
            <a href="<?= $base ?>make-payment.php"><i class="fas fa-arrow-right"></i> Make Payment</a>
          </li>
          <li class="<?php if($page=='payment-list') echo 'active'; ?>">
            <a href="<?= $base ?>payment-list.php"><i class="fas fa-arrow-right"></i> Payment List</a>
          </li>
          <li class="<?php if($page=='record-payment') echo 'active'; ?>">
            <a href="<?= $base ?>record-payment.php"><i class="fas fa-arrow-right"></i> Record Payment</a>
          </li>
          <?php if (!empty($user_menu['member_collections'])): ?>
          <li class="<?php if($page=='member-collections') echo 'active'; ?>">
            <a href="<?= $base ?>member-collections.php"><i class="fas fa-arrow-right"></i> Member Collections</a>
          </li>
          <?php endif; ?>
          <?php if (!empty($user_menu['salary_payments'])): ?>
          <li class="<?php if($page=='salary-payments') echo 'active'; ?>">
            <a href="<?= $base ?>salary-payments.php"><i class="fas fa-arrow-right"></i> Salary Payments</a>
          </li>
          <?php endif; ?>
          <?php if (!empty($user_menu['search_payment'])): ?>
          <li class="<?php if($page=='search-payment') echo 'active'; ?>">
            <a href="<?= $base ?>search-payment.php"><i class="fas fa-arrow-right"></i> Search Payments</a>
          </li>
          <?php endif; ?>
          <?php if (!empty($user_menu['payment_report'])): ?>
          <li class="<?php if($page=='payment-report') echo 'active'; ?>">
            <a href="<?= $base ?>payment-report.php"><i class="fas fa-arrow-right"></i> Payment Report</a>
          </li>
          <?php endif; ?>
          <?php endif; ?>
        </ul>
      ...
      <li class="<?php if($page=='expenses') echo 'active'; ?>">
        <a href="<?= $base ?>expenses.php"><i class="fas fa-receipt"></i><span>Expenses</span></a>
      </li>
      <?php endif; ?>
      ...
      <li class="submenu">
        ...
        <ul class="submenu-items">
          <li class="<?php if($page=='equipment-list') echo 'active'; ?>">
            <a href="<?= $base ?>equipment-list.php"><i class="fas fa-arrow-right"></i> List All Equipment</a>
          </li>
          <li class="<?php if($page=='equipment-add') echo 'active'; ?>">
            <a href="<?= $base ?>equipment-add.php"><i class="fas fa-arrow-right"></i> Add Equipment</a>
          </li>
          <li class="<?php if($page=='equipment-report') echo 'active'; ?>">
            <a href="<?= $base ?>equipment-report.php"><i class="fas fa-arrow-right"></i> Equipment Reports</a>
          </li>
        </ul>
      </li>
      <?php endif; ?>
      ...
      <li class="<?php if($page=='my-profile') echo 'active'; ?>">
        <a href="<?= $base ?>my-profile.php"><i class="fas fa-user"></i><span>My Profile</span></a>
      </li>
      <?php endif; ?>
      ...
      <li class="<?php if($page=='my-workout') echo 'active'; ?>">
        <a href="<?= $base ?>my-workout.php"><i class="fas fa-dumbbell"></i><span>My Workout Plan</span></a>
      </li>
      <?php endif; ?>

      <?php if (!empty($user_menu['my_payments'])): ?>
      <li class="<?php if($page=='my-payments') echo 'active'; ?>">
        <a href="<?= $base ?>my-payments.php"><i class="fas fa-receipt"></i><span>My Payments</span></a>
      </li>
      <?php endif; ?>

      <?php if (!empty($user_menu['my_progress'])): ?>
      <li class="<?php if($page=='bmi') echo 'active'; ?>">
        <a href="<?= $base ?>bmi.php"><i class="fas fa-chart-line"></i><span>My Progress</span></a>
      </li>
      <?php endif; ?>

      <?php if (!empty($user_menu['reports'])): ?>
      <li class="<?php if($page=='reports') echo 'active'; ?>">
        <a href="<?= $base ?>reports.php"><i class="fas fa-chart-line"></i><span>Reports</span></a>
      </li>
      <?php endif; ?>

      <?php if (!empty($user_menu['settings'])): ?>
      <li class="<?php if($page=='settings') echo 'active'; ?>">
        <a href="<?= $base ?>settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
      </li>
      <?php endif; ?>
