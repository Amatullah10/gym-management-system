...
<li class="submenu">
  <input type="checkbox" id="reports" class="toggle-input">
  <label for="reports" class="submenu-label">
    <i class="fas fa-chart-bar"></i><span>Reports</span>
  </label>
  <ul class="submenu-items">
    <li class="<?php if($page=='weight'){ echo 'active'; }?>">
      <a href="income-reports.php"><i class="fas fa-arrow-right"></i> Income Report</a>
    </li>
    <li class="<?php if($page=='bmi'){ echo 'active'; }?>">
      <a href="member-progress-report.php"><i class="fas fa-arrow-right"></i> Member Progress Report </a>
    </li>
    <li class="<?php if($page=='bmi'){ echo 'active'; }?>">
      <a href="attendance-report.php"><i class="fas fa-arrow-right"></i> Attendance Report </a>
    </li>
  </ul>
</li>
