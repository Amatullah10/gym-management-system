  ...
  <div class="main-content">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-info"><h3><?= $total_exercises ?></h3><p>Total Exercises Logged</p></div>
      </div>
      <div class="stat-card">
    ...
    <div class="form-container">
      ...
      <form method="POST">
        ...
        <button type="submit" class="app-btn-primary" style="margin-top:15px;"><i class="fa-solid fa-plus"></i> Log Exercise</button>
      </form>
    </div>
